...
proc create_root_design { parentCell } {
  ...
  set eth_in [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 eth_in ]
  set_property -dict [ list \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {0} \
   CONFIG.HAS_TREADY {1} \
  ...
  set eth_out [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 eth_out ]
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {eth_out:eth_in:m0_out:m0_in:m1_out:m2_out:m3_out:m1_in:m2_in:m3_in} \
 ] $clk
  set eth_in_interrupt [ create_bd_port -dir I -type intr eth_in_interrupt ]
  set m_in_interrupt [ create_bd_port -dir I -type intr m_in_interrupt ]
  ...
  connect_bd_intf_net -intf_net eth_in_1 [get_bd_intf_ports eth_in] [get_bd_intf_pins microblaze_0/S0_AXIS]
  connect_bd_intf_net -intf_net m1_in_1 [get_bd_intf_ports m1_in] [get_bd_intf_pins microblaze_0/S2_AXIS]
  connect_bd_intf_net -intf_net m2_in_1 [get_bd_intf_ports m2_in] [get_bd_intf_pins microblaze_0/S3_AXIS]
  connect_bd_intf_net -intf_net m3_in_1 [get_bd_intf_ports m3_in] [get_bd_intf_pins microblaze_0/S4_AXIS]
  connect_bd_intf_net -intf_net m_in_1 [get_bd_intf_ports m0_in] [get_bd_intf_pins microblaze_0/S1_AXIS]
  connect_bd_intf_net -intf_net microblaze_0_M0_AXIS [get_bd_intf_ports eth_out] [get_bd_intf_pins microblaze_0/M0_AXIS]
  connect_bd_intf_net -intf_net microblaze_0_M1_AXIS [get_bd_intf_ports m0_out] [get_bd_intf_pins microblaze_0/M1_AXIS]
  connect_bd_intf_net -intf_net microblaze_0_M2_AXIS [get_bd_intf_ports m1_out] [get_bd_intf_pins microblaze_0/M2_AXIS]
  connect_bd_intf_net -intf_net microblaze_0_M3_AXIS [get_bd_intf_ports m2_out] [get_bd_intf_pins microblaze_0/M3_AXIS]
  connect_bd_intf_net -intf_net microblaze_0_M4_AXIS [get_bd_intf_ports m3_out] [get_bd_intf_pins microblaze_0/M4_AXIS]
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  connect_bd_net -net eth_in_interrupt_1 [get_bd_ports eth_in_interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net m_in_interrupt_1 [get_bd_ports m_in_interrupt] [get_bd_pins xlconcat_0/In2]
