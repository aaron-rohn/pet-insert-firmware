...
create_clock -period 8.696 [get_ports m_data_clk_p[0]]
create_clock -period 8.696 [get_ports m_data_clk_p[1]]
create_clock -period 8.696 [get_ports m_data_clk_p[2]]
create_clock -period 8.696 [get_ports m_data_clk_p[3]]
