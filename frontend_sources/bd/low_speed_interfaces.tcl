...
################################################################
# This is a generated script based on design: low_speed_interfaces
#
...
# source low_speed_interfaces_script.tcl
...
if { $list_projs eq "" } {
   create_project project_1 myproj -part xc7a100tftg256-1
}


# CHANGE DESIGN NAME HERE
variable design_name
set design_name low_speed_interfaces
...
proc create_root_design { parentCell } {
  ...
  set rxd_interrupt [ create_bd_port -dir I -type intr rxd_interrupt ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_M0_AXIS [get_bd_intf_ports txd] [get_bd_intf_pins microblaze_0/M0_AXIS]
  ...
  connect_bd_intf_net -intf_net rxd_1 [get_bd_intf_ports rxd] [get_bd_intf_pins microblaze_0/S0_AXIS]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_ports Clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/Clk] [get_bd_pins rst_Clk_100M/slowest_sync_clk]
  connect_bd_net -net microblaze_0_intr [get_bd_pins microblaze_0_axi_intc/intr] [get_bd_pins microblaze_0_xlconcat/dout]
  connect_bd_net -net reset_rtl_0_1 [get_bd_ports rst] [get_bd_pins rst_Clk_100M/ext_reset_in]
  ...
  connect_bd_net -net rst_Clk_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_Clk_100M/peripheral_aresetn]
  connect_bd_net -net rxd_interrupt_1 [get_bd_ports rxd_interrupt] [get_bd_pins microblaze_0_xlconcat/In2]
